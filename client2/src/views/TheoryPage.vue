    ...
    <div class="container">
      <section>
        <div class="box wrap1">
          <ul>
            <router-link
              class="theoryLink"
              :to="{ name: 'PropisiuCestovnomPrometu' }"
              ><li>Propisi u cestovnom prometu</li></router-link
            >
            <router-link
              class="theoryLink"
            ...
            >
            <router-link class="theoryLink" :to="{ name: 'ZnakoviuPrometu' }"
      ...
      <section>
        <div class="box2 wrap2">
          <ul>
            <router-link class="theoryLink" :to="{ name: 'PrvaPomoc' }"
...
.box ul {
  background: rgba(88, 86, 86, 0.561);
}
